            ...
            Column(
              ...
              children: <Widget>[
                ...
                Container(
                    child: InkWell(
                  child: Text(
                      _dateTime == null ? "DD/MM/YYYY" : _showDate.toString(),
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 20,
                      ...
                      builder: (BuildContext context, Widget child) {
                        return Theme(
                          data: ThemeData.light().copyWith(
                              ...
                              colorScheme:
                                  ColorScheme.light(primary: Color(0xFFFE3C72)),
                          ...
                          _dateTime = date;
                          _showDate =
                              DateFormat.yMMMMd("en-US").format(_dateTime);
                        }));
                  },
                )),
                SizedBox(height: 20),
