...
//                onPressed: Navigator.pop(context),// to add routing later
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                      child: InkWell(
                        child: Text(_dateTime == null ? "DD/MM/YYYY" : _dateTime.toString(), style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w500),),
                        onTap: (){
                          showDatePicker(
                            context: context,
...
//                                    primarySwatch: const Color(0xFFFE3C72),//OK/Cancel button text color
                                    primaryColor: const Color(0xFFFE3C72),//Head background
                                    accentColor: const Color(0xFFFE3C72)//selection color
